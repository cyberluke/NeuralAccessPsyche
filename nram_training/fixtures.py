    ...
    try:
        ...
        for layer in range(40):
            for module in cfg.target_modules:
                ...
                value = 0.0 if not delta else 1e-4
                tensors[prefix + module + ".lora_A.weight"] = torch.full((cfg.lora_r, in_dim), value)
                tensors[prefix + module + ".lora_B.weight"] = torch.full((out_dim, cfg.lora_r), value)
