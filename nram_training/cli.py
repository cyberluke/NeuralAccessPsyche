...
def main(argv=None) -> int:
    ...
    t.add_argument("--model", default=None); t.add_argument("--max-steps", type=int, default=None); t.add_argument("--tiny", action="store_true")
    ...
    if args.command == "train": train(args.adapter, args.output_dir, resume=args.resume, model_name=args.model, max_steps=args.max_steps, tiny=args.tiny); return 0
